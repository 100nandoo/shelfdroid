...
- [ ] prevent OOM when `/api/libraries/{libraryId}/items` returns the entire library;
  see [library items response OOM](docs/scratch/library-items-response-oom/spec.md)
