...
internal fun LibraryAdminDirectoryItem(directory: LibraryAdminDirectory, onOpen: () -> Unit) {
  ListItem(
    ...
    leadingContent = {
      Icon(painterResource(CoreUiR.drawable.folder_rounded), contentDescription = null)
    },
    trailingContent = {
      Icon(painterResource(CoreUiR.drawable.chevron_right), contentDescription = null)
    },
  )
}
