...
class AppTest {
  ...
  @Test
  fun home_supports_media_drill_down() {
    launchMainActivity()
    login()
  ...
  fun home_supports_relogin_from_settings() {
    ...
    composeTestRule.onAllNodesWithText("Settings")[1].performClick()
  ...
  fun api_key_screen_renders_seeded_list() {
    ...
    composeTestRule.onNodeWithText("Primary Key", substring = true).assertExists()
  }
