...
/**
 * The server intentionally omits the authorization header from its normal client projection.
 * The nullable field lets controlled fakes and compatible server versions exercise the
 * conceal/reveal presentation without persisting the value in ShelfDroid.
 */
@Serializable
