...
data class LibraryItemsResponse(
  @SerialName("results") val results: List<LibraryItem> = listOf(),
  ...
  @SerialName("collapseseries") val collapseseries: Boolean = false,
...
data class LibraryItem(
  ...
  @SerialName("mtimeMs") val mtimeMs: Long = 0,
  @SerialName("ctimeMs") val ctimeMs: Long = 0,
  @SerialName("birthtimeMs") val birthtimeMs: Long = 0,
  @SerialName("addedAt") val addedAt: Long = 0,
  @SerialName("updatedAt") val updatedAt: Long = 0,
  @SerialName("lastScan") val lastScan: Long? = 0,
  @SerialName("scanVersion") val scanVersion: String? = "",
