...
| [07](issues/07-hardening-and-verification.md) | Harden and verify Authentication settings | 04, 05, 06 | `ready-for-human` |

Tickets 01 through 07 are ready for human verification. Only the explicitly documented manual
verification items in ticket 07 remain.
