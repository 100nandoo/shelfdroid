...
import dev.halim.shelfdroid.widget.PlaybackWidgetSynchronization
...
class ShelfDroid : Application(), SingletonImageLoader.Factory {
  ...
  @Inject lateinit var playbackWidgetSynchronization: PlaybackWidgetSynchronization

  override fun onCreate() {
    super.onCreate()
    playbackWidgetSynchronization.start()
  }
